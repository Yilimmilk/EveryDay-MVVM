...
public class UIConfig {
    ...
    public static final String[] WEEK_INFO_ONE = {"周日", "周一", "周二", "周三", "周四", "周五", "周六"};
    public static final String[] WEEK_INFO_TWO = {"日","一", "二", "三", "四", "五", "六"};
    ...
    private final boolean SHOW_CURRENT_MONTH = true;
    ...
    /*weekinfo集合*/
    private String[] weekInfoStyle = WEEK_INFO_ONE;
    /*选中项（当前日是周几）的颜色，默认为红*/
    ...
    /*是否显示当前月份*/
    private boolean isShowCurrentMonth = SHOW_CURRENT_MONTH;
    /*是否显示时间表*/
    ...
    public boolean isShowCurrentMonth() {
        return isShowCurrentMonth;
    }

    public void setShowCurrentMonth(boolean showCurrentMonth) {
        isShowCurrentMonth = showCurrentMonth;
    }

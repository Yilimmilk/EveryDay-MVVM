...
public class PopupWindowUtil {
     ...
     * @return
     */
    public PopupWindowUtil showAtLocation(View view, int gravity, int x, int y) {
     ...
     * @return
     */
    public PopupWindowUtil showAsDropDown(View anchor, int xoff, int yoff, int gravity) {
        if (mPopupWindow != null) {
